...
4.Read Matrix A and check each element:

5.If every element is odd, continue.

6.If any element is even, mark A as invalid and stop further checking.

7.Read Matrix A and check each element:

8.If every element is odd, continue.
If any element is even, mark A as invalid and stop further checking.

9.If both matrices are valid, compute the resultant matrix (e.g., A + B or any operation specified).
...
11.Display the Resultant Matrix.
